...
export default function AdminQuotationsEdit({ quotation, clients }) {
    ...
    return (
        <AdminLayout title="Edit Quotation">
            <Head title="Edit Quotation — Admin" />
                        ...
                        <div className="card p-6">
                            ...
                            <div className="space-y-4">
                                {data.items.map((item, index) => (
                                    <div key={item.id ?? index} className="rounded-xl border border-[#1a4445] p-4 space-y-4">
